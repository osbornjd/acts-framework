...
namespace SimEvent {
  ...
  template <class E>
  static void
  momentumUnit(E* event, const double momentumUnit)
  {
  ...
  template <class E>
  static void
  lengthUnit(E* event, const double lengthUnit)
  {
  ...
  template <class E>
  static void
  shiftPositionTo(E* event, const Acts::Vector3D& deltaPos)
  {
  ...
  template <class E>
  static void
  shiftPositionTo(E* event, const double deltaTime)
  {
