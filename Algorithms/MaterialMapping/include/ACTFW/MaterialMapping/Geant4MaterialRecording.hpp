...
/// @class Geant4MaterialRecording
///
/// @brief records the simulation geometry by using geantinos
///
/// The Geant4MaterialRecording algorithm initiates the geant4 simulation
...
class Geant4MaterialRecording : public FW::BareAlgorithm
{
public:
  /// @class Config
  struct Config
  {
    ...
    std::string recordedMaterialCollection = "RecordedG4Material";
  ...
  /// Constructor
  Geant4MaterialRecording(const Config&        cnf,
