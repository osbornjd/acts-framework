...
class GeometryService : public FW::IDD4hepService,
 ...
 private:
  ...
  FW::ProcessCode buildTrackingGeometry();
...
inline const std::string& GeometryService::name() const { return m_cfg.name; }
}
