...
FW::G4::G4EmStandardPhysics::G4EmStandardPhysics(G4int ver)
  : G4VPhysicsConstructor("G4EmStandard"), verbose(ver)
{
  ...
  std::cout << "construct G4EmStandard" << std::endl;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

FW::G4::G4EmStandardPhysics::G4EmStandardPhysics(G4int ver, const G4String&)
  : G4VPhysicsConstructor("G4EmStandard"), verbose(ver)
{
  G4EmParameters* param = G4EmParameters::Instance();
  param->SetDefaults();
...
FW::G4::G4EmStandardPhysics::~G4EmStandardPhysics()
{
}
...
void
FW::G4::G4EmStandardPhysics::ConstructProcess()
{
  if (verbose > 1) {
    G4cout << "### " << GetPhysicsName() << " Construct Processes " << G4endl;
  }

  std::cout << "G4EmStandardPhysics::ConstructProcess()" << std::endl;
  ...
  while ((*aParticleIterator)()) {
    ...
    if (particleName == "gamma") {
      ...
      //     ph->RegisterProcess(ionisation, particle);
