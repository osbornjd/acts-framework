...
template <class T> class RootTrackParametersWriter
  : public FW::WriterT< std::vector< T > >
{
public:
  ...
  public:
    ...
    std::string treeName = "propagation_results";  ///< name of the output tree
  };
...
protected:
  ...
  std::vector<int>   m_tag;              ///< the tag which one is present (in case of failure)
