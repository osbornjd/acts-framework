...
/// The HepMC::GenEvent usually stores a single event. This class is a child class from this class and extends the class by a persistent storage in ACTS data types.
///
