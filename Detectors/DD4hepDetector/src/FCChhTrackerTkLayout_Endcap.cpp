...
createTkLayoutTrackerEndcap(DD4hep::Geometry::LCDD&             lcdd,
                            ...
                            DD4hep::Geometry::SensitiveDetector sensDet)
{
  ...
  DD4hep::Geometry::Tube envelopeShape(dimensions.rmin() - l_overlapMargin,
  ...
  DD4hep::Geometry::Tube discShape(dimensions.rmin() - l_overlapMargin,
                                   dimensions.rmax() + l_overlapMargin,
    ...
    for (DD4hep::XML::Collection_t xRingColl(xFirstDiscRings, _U(ring));
      ...
      for (DD4hep::XML::Collection_t xCompColl(xModulePropertiesComp,
        ...
        for (unsigned int phiIndex = 0; phiIndex < nPhi; ++phiIndex) {
          ...
          // position in  disk
          DD4hep::Geometry::Translation3D lTranslation(
              lX, lY, lZ + componentOffset);
          DD4hep::Geometry::Transform3D myTrafo(
  ...
  DD4hep::Geometry::Translation3D envelopeTranslation(
