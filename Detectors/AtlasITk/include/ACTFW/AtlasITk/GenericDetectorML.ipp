...
bplConfig.centralLayerHalflengthZ
    = std::vector<double>(1, 3000. * Acts::units::_mm);
bplConfig.centralLayerThickness
    = std::vector<double>(1, 0.8 * Acts::units::_mm);
...
// some prep work
// envelope for layers
std::pair<double, double> pcEnvelope(2. * Acts::units::_mm,
                                     2. * Acts::units::_mm);
...
plbConfig.centralLayerRadii          = {50.5 * Acts::units::_mm,
                               88.5 * Acts::units::_mm,
                               122.5 * Acts::units::_mm};
...
plbConfig.centralModuleHalfX         = {1.64 / 2 * Acts::units::_cm,
                                1.64 / 2 * Acts::units::_cm,
                                1.64 / 2 * Acts::units::_cm};
plbConfig.centralModuleHalfY = {6.16 / 2 * Acts::units::_cm,
                                6.16 / 2 * Acts::units::_cm,
                                6.16 / 2 * Acts::units::_cm};  // 6.08 cm active
plbConfig.centralModuleThickness = {256. * Acts::units::_um,
                                    256. * Acts::units::_um,
                                    256. * Acts::units::_um};
...
plbConfig.posnegLayerEnvelopeR
...
plbConfig.posnegLayerMaterialProperties = {pcmProperties,
                                           ...
                                           pcmProperties,
                                           pcmProperties};
std::vector<double> perHX
    = {34.87 * Acts::units::_mm, 34.87 * Acts::units::_mm};  // half length x
std::vector<double> perHY
    = {30.4 * Acts::units::_mm, 30.4 * Acts::units::_mm};  // half length y
...
sslbConfig.centralLayerRadii          = {299. * Acts::units::_mm,
                                371. * Acts::units::_mm,
                                443. * Acts::units::_mm,
                                514. * Acts::units::_mm};
...
sslbConfig.centralModuleHalfX   = {58.27 / 2 * Acts::units::_mm,
                                 58.27 / 2 * Acts::units::_mm,
                                 58.27 / 2 * Acts::units::_mm,
                                 58.27 / 2 * Acts::units::_mm};
sslbConfig.centralModuleHalfY = {128.18 / 2 * Acts::units::_mm,
                                 128.18 / 2 * Acts::units::_mm,
                                 128.18 / 2 * Acts::units::_mm,
                                 128.18 / 2 * Acts::units::_mm};
...
sslbConfig.posnegModuleFrontsideStereo
    = std::vector<std::vector<double>>(nposnegs, {-0.02, -0.02, -0.02});
sslbConfig.posnegModuleBacksideStereo
    = std::vector<std::vector<double>>(nposnegs, {0.02, 0.02, 0.02});
sslbConfig.posnegModuleBacksideGap
    = std::vector<std::vector<double>>(nposnegs, {1., 1., 1.});

// mPositions
std::vector<std::vector<std::vector<Acts::Vector3D>>> sslbPosnegModulePositions;

// std::vector<double> rMin = {275., 337.6, 337.6, 337.6, 337.6, 337.6, 337.6,
// 337.6, 438.7};
// std::vector<double> rMax = {334.1, 455.3, 455.3, 455.3, 455.3, 455.3, 455.3,
// 455.3, 560.};
